...
export default function EditServicePage() {
        ...
        const fetchService = async () => {
            try {
                ...
                if (data.success) {
                    ...
                    // Ensure features and benefits arrays are not empty for UI
                    if (!service.hero.features || service.hero.features.length === 0) service.hero.features = [""]
                    if (!service.cta.benefits || service.cta.benefits.length === 0) service.cta.benefits = [""]
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.error(error.message || "فشل تحديث الخدمة")
        } finally {
            setIsLoading(false)
        }
    }
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground mt-1">تعديل محتوى وتفاصيل الخدمة</p>
                    </div>
                </div>
