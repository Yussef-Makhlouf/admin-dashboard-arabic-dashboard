...
export default function EditBlogPage() {
        ...
        const fetchBlog = async () => {
            try {
                ...
                if (data.success) {
                    ...
                    // Fix tags if they are undefined or string
    ...
    const handleTitleChange = (title: string) => {
        // We generally don't want to auto-change slug on edit unless user explicitely clears slug field,
        // but for now let's just update title. User can manually update slug.
        setFormData({
            ...formData,
            title,
        })
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground mt-1">تعديل محتوى وتفاصيل المقال</p>
                    </div>
                </div>
